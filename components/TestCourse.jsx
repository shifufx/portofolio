...
const TestCourse = () => {
  ...
  return (
    ...
    <div class="container px-6 py-8 mx-auto">
        <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Simple pricing plan</h1>
        ...
        <div class="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
            ...
            <button class={"flex items-center justify-between px-8 py-4 border cursor-pointer rounded-xl dark:border-gray-700" + 
            (openTab === 1
            ...
            {/* start pro section */}
            <button class={"flex items-center justify-between px-8 py-4 border border-blue-500 cursor-pointer rounded-xl" +
            setOpenTab === 2 
            ? "text-white "
            : "text-white"
            }
...
function profesional(){
    ...
    return(
        <>
            ...
            <div class={"flex items-center justify-between text-gray-800 dark:text-gray-200" + openTab === 1 ? 'block' : 'hidden'} id="link1" >
