...
function panda(){
    return(
        <div className="overflow-hidden bg-white rounded shadow">
                ...
                <a href="" className='inline-flex py-3 px-20 bg-transparent rounded-full font-bold text-black mt-5 ml-[3rem] mb-3 border-2 border-b-gray-900 border-t-2 border-t-black border-r-black border-l-black hover:shadow-[inset_19rem_0_0_0] hover:shadow-teal-600 duration-[400ms,700ms] transition-[color,box-shadow] hover:text-white'>
...
function mantis(){
    return(
        <div className="overflow-hidden bg-white rounded shadow">
                ...
                <a href="" className='inline-flex py-3 px-20 bg-transparent rounded-full font-bold text-black mt-12 ml-[3rem] mb-3 border-2 border-b-gray-900 border-t-2 border-t-black border-r-black border-l-black hover:shadow-[inset_19rem_0_0_0] hover:shadow-teal-600 duration-[400ms,700ms] transition-[color,box-shadow] hover:text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 3 24 24" fill="currentColor" className="w-6 h-6 mr-1">
                        <path fillRule="evenodd" d="M12 2.25a.75.75 0 01.75.75v11.69l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V3a.75.75 0 01.75-.75zm-9 13.5a.75.75 0 01.75.75v2.25a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V16.5a.75.75 0 011.5 0v2.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V16.5a.75.75 0 01.75-.75z" clipRule="evenodd" />
                    </svg>
                        Download
...
function tiger(){
    return(
        <div className="overflow-hidden bg-white rounded shadow">
                ...
                <div className="button my-5 lg:ml-0 md:ml-10">
                <a href="" className='inline-flex py-3 px-20 bg-transparent rounded-full font-bold text-black mt-7 ml-[3rem] mb-3 border-2 border-b-gray-900 border-t-2 border-t-black border-r-black border-l-black hover:shadow-[inset_19rem_0_0_0] hover:shadow-teal-600 duration-[400ms,700ms] transition-[color,box-shadow] hover:text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 3 24 24" fill="currentColor" className="w-6 h-6 mr-1">
                        <path fillRule="evenodd" d="M12 2.25a.75.75 0 01.75.75v11.69l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V3a.75.75 0 01.75-.75zm-9 13.5a.75.75 0 01.75.75v2.25a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V16.5a.75.75 0 011.5 0v2.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V16.5a.75.75 0 01.75-.75z" clipRule="evenodd" />
                    </svg>
                        Download
...
function flamingo(){
    return(
        <div className="overflow-hidden bg-white rounded shadow">
                ...
                <div className="button my-5 lg:ml-0 md:ml-10">
                <a href="" className='inline-flex py-3 px-20 bg-transparent rounded-full font-bold text-black mt-14 ml-[3rem] mb-3 border-2 border-b-gray-900 border-t-2 border-t-black border-r-black border-l-black hover:shadow-[inset_19rem_0_0_0] hover:shadow-teal-600 duration-[400ms,700ms] transition-[color,box-shadow] hover:text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 3 24 24" fill="currentColor" className="w-6 h-6 mr-1">
                        <path fillRule="evenodd" d="M12 2.25a.75.75 0 01.75.75v11.69l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V3a.75.75 0 01.75-.75zm-9 13.5a.75.75 0 01.75.75v2.25a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V16.5a.75.75 0 011.5 0v2.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V16.5a.75.75 0 01.75-.75z" clipRule="evenodd" />
                    </svg>
                        Download
...
function snake(){
    return(
        <div className="overflow-hidden bg-white rounded shadow">
                ...
                <div className="button my-5 lg:ml-0 md:ml-10">
                <a href="" className='inline-flex py-3 px-20 bg-transparent rounded-full font-bold text-black mt-9 ml-[3rem] mb-3 border-2 border-b-gray-900 border-t-2 border-t-black border-r-black border-l-black hover:shadow-[inset_19rem_0_0_0] hover:shadow-teal-600 duration-[400ms,700ms] transition-[color,box-shadow] hover:text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 3 24 24" fill="currentColor" className="w-6 h-6 mr-1">
                        <path fillRule="evenodd" d="M12 2.25a.75.75 0 01.75.75v11.69l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V3a.75.75 0 01.75-.75zm-9 13.5a.75.75 0 01.75.75v2.25a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V16.5a.75.75 0 011.5 0v2.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V16.5a.75.75 0 01.75-.75z" clipRule="evenodd" />
                    </svg>
                        Download
