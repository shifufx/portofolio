                ...
                <div className="p-5 text-white z-[2] mt-[8rem] ml-[6rem]">
                    <div className="user flex flex-wrap px-3 mb-6 ">
                        <div className="lg:w-2/5 md:w-2/6">
                            <img src="/Batch/test-1.jpg" alt="..." className="shadow rounded-full w-1/2 h-auto align-middle bg-gradient-to-r from-rose-500 via-fuchsia-500 to-cyan-400 p-1" />
                        </div>
                    </div>
                    <h2 className="lg:text-4xl  sm:text-xl font-bold flex ">Hello i'm Ryan as a
                    ...
                    <p className="py-5 lg:text-xl leading-relaxed" data-aos="fade-right" data-aos-delay="230" data-aos-easing="ease-in-out" data-aos-duration="1000"> Build your mindset. Right here.</p>
