        ...
        <div className="items-center justify-start h-screen">
            <div className="absolute top-0 left-0 right-0 bottom-0 bg-black">
                <div className="p-5 text-white z-[2] mt-[8rem] md:mt-[10rem]] md:ml-3">
                    ...
                    <h2 className="lg:text-4xl md:text-3xl sm:text-xl font-bold flex ">Hello i'm Ryan as a
                    ...
                    <p className="py-5 lg:text-xl md:text-xl leading-relaxed" data-aos="fade-right" data-aos-delay="230" data-aos-easing="ease-in-out" data-aos-duration="1000"> Build your mindset. Right here.</p>
