    ...
    return(
        <div className="overflow-hidden bg-black rounded shadow">
            <div className="p-8">
                ...
                <p className='pt-5 my-2 font-bold text-white text-center mt-1'>Lifetime Education</p>
    ...
    return(
        <div className="overflow-hidden bg-black rounded shadow">
            <div className="p-8">
                ...
                <p className=' pt-5 my-2 font-bold text-white text-center mt-4'>Become a Trader Professional</p>
                <p className="text-base leading-relaxed text-white mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste repudiandae pariatur optio! Labore, illum magni repudiandae saepe iste quae non ratione expedita accusantium facere vel odio minima nam impedit similique.</p>
            </div>
        </div>
    ...
    return(
        <div className="overflow-hidden bg-black rounded shadow">
            <div className="p-8">
                ...
                <p className='pt-5 my-2 font-bold text-white text-center mt-4'>Build Your Own Target</p>
                <p className="text-base leading-relaxed text-white mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste repudiandae pariatur optio! Labore, illum magni repudiandae saepe iste quae non ratione expedita accusantium facere vel odio minima nam impedit similique.</p>
            </div>
        </div>
    )
    ...
    return(
        <div className="overflow-hidden bg-black rounded shadow">
            <div className="p-8 ">
                ...
                <p className='pt-5 my-2 font-bold text-white text-center mt-0'>Flexible Time</p>
    ...
    return(
        <div className="overflow-hidden bg-black rounded shadow">
            <div className="p-8 ">
                ...
                <p className='pt-5 my-2 font-bold text-white text-center sm:mt-0'>Make More Money</p>
                <p className="text-base leading-relaxed text-white mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste repudiandae pariatur optio! Labore, illum magni repudiandae saepe iste quae non ratione expedita accusantium facere vel odio minima nam impedit similique.</p>
...
function Broker(){
    return(
        <div className="overflow-hidden bg-black rounded shadow">
            <div className="p-8 ">
                <div className="">
                    <Player className="flex-shrink-0 xl:w-[9.6rem] md:w-[10rem] h-auto" src={"/svg/security.json"} loop autoplay />
                </div>
                <p className='pt-5 my-2 font-bold text-white text-center sm:mt-0'>Broker We can Trust</p>
                <p className="text-base leading-relaxed text-white mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste repudiandae pariatur optio! Labore, illum magni repudiandae saepe iste quae non ratione expedita accusantium facere vel odio minima nam impedit similique.</p>
                {/* <p className="text-base leading-relaxed text-gray-600 mt-7">Lorem ipsum dolor sit amet, consectetur adipis cing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p> */}
            </div>
        </div>
