...
<div className="bg-black">
    <div className="container px-6 py-8 mx-auto">
        <h1 className="text-2xl font-bold text-center text-gray-50 capitalize lg:text-4xl dark:text-white" data-aos="fade-up" data-aos-delay="230" data-aos-easing="ease-in-out" data-aos-duration="1000">{t.titleOffer} <span className='text-cyan-300'>{t.offer}</span></h1>
        ...
        <p className="max-w-2xl mx-auto mt-4 text-center text-gray-50 xl:mt-6 dark:text-gray-300" data-aos="fade-up" data-aos-delay="230" data-aos-easing="ease-in-out" data-aos-duration="1000">
            {t.descriptionOffer} <span className='text-cyan-300'>{t.free}</span>
        </p>
        ...
        <div className="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12" data-aos="fade-up" data-aos-delay="230" data-aos-easing="ease-in-out" data-aos-duration="1000">
            ...
            >
                <div className="flex flex-col items-center space-y-1">
                    ...
                    <h2 className="text-lg font-medium text-gray-700 sm:text-xl dark:text-gray-200">{t.basic}</h2>
                </div>

                <h2 className="text-2xl font-semibold text-gray-500 sm:text-3xl dark:text-gray-300">{t.free}</h2>
            </button>
            ...
            <a href='/course' className="flex items-center justify-between px-8 py-4 border cursor-pointer rounded-xl dark:border-gray-700 hover:border-blue-600">
                <div className="flex flex-col items-center space-y-1">
                    <h2 className="text-lg font-medium text-gray-700 sm:text-xl dark:text-gray-200">{t.exclusiveEbook6}</h2>
                </div>
    ...
    return(
        ...
        <div className='p-1 mt-1 space-y-8'>
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-200">
                <p className="textlg sm:text-xl">{t.exclusiveEbook5}</p>
            ...
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-200">
                <p className="textlg sm:text-xl">{t.exclusiveEbook2}</p>
            ...
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-200">
                <p className="textlg sm:text-xl">{t.exclusiveEbook3}</p>
            ...
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-200">
                <p className="textlg sm:text-xl">{t.exclusiveEbook4}</p>
...
<>
    <div className="p-8 mt-8 space-y-8 bg-gray-800 rounded-xl">
        <div className='p-1 mt-1 space-y-8'>
            <div className="flex items-center justify-between text-gray-800 dark:text-gray-200">
                <p className="textlg sm:text-xl">{t.exclusiveEbook}</p>
